...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nUndefined variable.\n  ╷\n3 │     grid-template-columns: repeat($board-size, $cell-size);\n  │                                   ^^^^^^^^^^^\n  ╵\n  src/components/sass/board.module.scss 3:35  root stylesheet");
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nUndefined variable.\n  ╷\n2 │   width: $cell-size;\n  │          ^^^^^^^^^^\n  ╵\n  src/components/sass/cell.module.scss 2:10  root stylesheet");
...
/******/ })()
;
//# sourceMappingURL=App.f45a84d0d35b8aaf4786254b6390748c.js.map